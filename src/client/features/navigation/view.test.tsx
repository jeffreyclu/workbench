...
describe('NavigationView', () => {
  function renderNav() {
    ...
    render(<QueryClientProvider client={client}><NavigationView
      ...
      mobileNavOpen={false}
      isCompactNav={false}
      counts={{ attention: { active: 1, archive: 0, groups: { progress: 0, attention: 1, pinned: 0 } }, workbench: { active: 2, archive: 0, groups: { progress: 0, attention: 2, pinned: 0 } }, conversations: { active: 3, archive: 0 } }}
      onOpenActive={vi.fn()}
