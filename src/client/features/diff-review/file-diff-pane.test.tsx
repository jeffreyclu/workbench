...
describe('review file diff pane', () => {
  ...
  it('shows one reviewable group with a per-file summary for repeated edits', () => {
    const repeated: ReviewDecision = {
      ...decision(null),
      ...
      repetition: {
        otherLocations: 1,
        files: [
          { filePath: 'src/example.ts', locations: ['Lines 1–4'], additions: 1, deletions: 1 },
          { filePath: 'src/other.ts', locations: ['Line 20'], additions: 1, deletions: 1 },
        ],
      },
    };
    ...
    const summary = screen.getByLabelText('Repeated edit applies to 1 other location');
    expect(summary).toHaveTextContent('Repeated edit · applies to 1 other location');
    expect(summary).toHaveTextContent('src/example.tsLines 1–4 · +1 −1');
    expect(summary).toHaveTextContent('src/other.tsLine 20 · +1 −1');
  });
