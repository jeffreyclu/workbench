...
const decision: ReviewDecision = {
  ...
  hunks: [{ id: hunks[0].decisionId, filePath: 'src/example.ts', fileStatus: 'modified', editorUrl: null, hunkRange: hunks[0].range, location: hunks[0].location, contentHash: 'hash-1', lines: [], additions: 1, deletions: 1, state: null, note: null }],
