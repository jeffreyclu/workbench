...
export const conversationClient = {
  ...
  updateSharedConversationPreferences: (id: string, preferences: Partial<{ executionProfile: AgentRun['executionProfile']; accountProfile: string | null; dispatchTarget: 'both' | 'codex' | 'claude' | 'palmyra' | null; aiProvider: AiProviderChoice | null }>) => request<{ conversation: SharedConversation }>(`/api/shared/conversations/${id}/preferences`, { method: 'PATCH', body: JSON.stringify(preferences) }),
