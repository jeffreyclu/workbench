...
const baselineInventory = [
  ...
  'POST /api/review-assist/critical',
  ...
  'GET /api/shared/conversations/:id/workspace-diff/refs',
  'GET /api/shared/conversations/:id/workspace-diff/ref',
  ...
  'POST /api/shared/messages/:id/retry-synthesis',
  ...
  'GET /api/work-items/:id/workspace-diff/ref',
