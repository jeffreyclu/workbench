...
sed "s|__REPO__|$repo|g; s|__AGENT_BIN_DIR__|$agent_bin_dir|g; s|__NODE_DIR__|$node_dir|g; s|__NODE__|$node|g" "$repo/scripts/workbench-runtime.plist.template" > "$plist"
